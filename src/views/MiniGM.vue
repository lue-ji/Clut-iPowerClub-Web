...
.glass-board {
  position: relative; z-index: 10; width: 90%; max-width: 900px; height: 80vh; min-height: 600px;
...
.game-cards-container { display: flex; gap: 24px; width: 100%; max-width: 800px; justify-content: center; margin-bottom: 40px; }

.game-card { flex: 1; background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 20px; padding: 30px 20px; transition: all 0.3s ease; display: flex; flex-direction: column; align-items: center; cursor: pointer;}
